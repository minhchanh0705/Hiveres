...
import { FiAward, FiCopy, FiPercent, FiDatabase } from "react-icons/fi";
import { IoArrowBackCircleOutline } from "react-icons/io5";
import { colors, text, space, sizeRatio } from "@/theme";
...
const JobsAccountDetail = () => {
  const { state } = useLocation();
  const { id, walletId } = state;
  ...
  const { NeutralDay000, NeutralDay900, SuccessGreen900 } = colors;
  const {
    Row,
    RowSpaceBetween,
    RowCenter,
              ...
              >
                <Button
                  style={{
                    ...
                    paddingInline: sizeRatio(32),
                    borderRadius: sizeRatio(8),
                    backgroundColor: SuccessGreen900,
                  }}
                >
                  <FaRegHandPaper
                    style={{
...
export default JobsAccountDetail;
